...
public class AdminRegister extends JPanel implements ActionListener {
	
	JLabel lblUsername, lblPassword, lblConfirmPassword, lblInstitute;
	...
	public AdminRegister() {
		...
		b = BorderFactory.createMatteBorder(5, 5, 5, 5, new ImageIcon("images/admin.png"));
		setBorder(b);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource() == btnRegister) {
			...
			try {
				...
				String urlLink = "http://localhost/LMS/adminRegister.php";
